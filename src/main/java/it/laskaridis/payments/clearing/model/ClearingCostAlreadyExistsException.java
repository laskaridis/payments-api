 ...
 */
public class ClearingCostAlreadyExistsException extends ResourceAlreadyTakenException {
    public ClearingCostAlreadyExistsException(String cardIssuingCountry) {
